...
export default function Note8({ Navigation }) {
  return (
        ...
        <View style={styles.view_point}>
          <View style={styles.cover}>
            ...
            <Text style={styles.content}>
              Priyanshu Bhatt<Text style={styles.her}>(he\him)</Text>
            </Text>
            <Text style={styles.para}>
              WEB DEVELOPER ||APP DEVELOPER|| CSE'2024 || INSTITUTE OF
              TECHNOLOGY GOPESHWAR
            </Text>
            <Text style={styles.based}>RISHIKESH,UTTARAKHAND,INDIA</Text>
            <Text style={styles.numbr}>1500+ Connections</Text>
