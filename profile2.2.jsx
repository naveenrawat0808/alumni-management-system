...
export default function Note7({ Navigation }) {
  return (
        ...
        <View style={styles.view_point}>
          <View style={styles.cover}>
            ...
            <Text style={styles.content}>
              Neeraj Bisht<Text style={styles.her}>(he\him)</Text>
            </Text>
            <Text style={styles.para}>
              WEB DEVELOPER ||APP DEVELOPER|| CSE'2024 || INSTITUTE OF
              TECHNOLOGY GOPESHWAR
            </Text>
            <Text style={styles.based}>SHRINAGAR,UTTARAKHAND,INDIA</Text>
            <Text style={styles.numbr}>1000+ Connections</Text>
